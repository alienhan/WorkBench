...
/**
 * error: java.lang.UnsupportedClassVersionError: javax/servlet/ServletContext :
 * Unsupported major.minor version 51.0 solution: 添加@TestExecutionListeners
 * 
 * error: 当em 非spring生成，transaction会报错
 * 
 * 
...
@Transactional
// 加载事务管理类，可以省略
//将回滚设置成false ，否则只输入sql语句，不对数据库进行操作
